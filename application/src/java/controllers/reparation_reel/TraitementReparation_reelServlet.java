...
@WebServlet("/TraitementReparation_reelServlet")
public class TraitementReparation_reelServlet extends HttpServlet {
	...
	private void Default(HttpServletRequest request, HttpServletResponse response,Connection connection) throws Exception {
		...
		List<Reparation_reel> reparation_reelList = Reparation_reel.getAll(connection);
		request.setAttribute("reparation_reelList", reparation_reelList);
		forwardRequest(request, response, "pages/reparation/reparation_reel.jsp");
	}
