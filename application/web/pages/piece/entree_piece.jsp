					...
					<tbody>
						<% if (entree_pieceList != null) { %>
							<% for (Entree_piece entree_piecevalue : entree_pieceList) { %>
								...
								<td><a href="FormActionEntree_pieceServlet?action=handleUpdate&id_entree_piece=<%=entree_piecevalue.getId_entree_piece() %>"><i class="far fa-edit"></i></a><a href="FormActionEntree_pieceServlet?action=delete&id_entree_piece=<%=entree_piecevalue.getId_entree_piece() %>"><i class="far fa-trash-alt"></i></a></td>
								</tr>
							<% } %>
						<% } %>
						</tbody>
