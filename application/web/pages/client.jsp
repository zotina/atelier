					...
					<tbody>
						<% if (clientList != null) { %>
							<% for (Client clientvalue : clientList) { %>
								...
								<td><a href="FormActionClientServlet?action=handleUpdate&id_client=<%=clientvalue.getId_client() %>"><i class="far fa-edit"></i></a></td>
								<td><a href="FormActionClientServlet?action=delete&id_client=<%=clientvalue.getId_client() %>"><i class="far fa-trash-alt"></i></a></td>
								</tr>
							<% } %>
						<% } %>
						</tbody>
