			...
			<div class="row w-100">
				<form action="FormActionAppareilServlet" method="post">
					...
					<div class="form-group">
						...
						<input type="datetime-local" class="form-control" id="date_deposition" name="date_deposition" value="<%= (appareil != null && appareil.getDate_deposition() != null) ? appareil.getDate_deposition() : "" %>">
					</div>
					<div class="form-group">
