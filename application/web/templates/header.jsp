...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#commission-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Commission </span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="commission-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="TraitementEmployeServlet?action=commission">
